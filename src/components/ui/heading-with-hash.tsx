  ...
  return (
    ...
    >
      ...
      >
        <span>{children}</span>
        <span 
          className="          opacity-0 scale-90 group-hover:opacity-100 group-hover:scale-100 transition-all duration-200 text-[#FAF3E0]/40 hover:text-[#FAF3E0]/80 cursor-pointer select-none text-sm"
