...
export const metadata: Metadata = {
  title: 'About Me - miiyuh',
  description: 'Computer forensics student, creative developer, and photographer based in Malaysia. Building digital experiences that matter.',
}
