...
export default function BlogPage() {
  return (
    <main className="flex flex-col bg-[#1A1A1A] text-[#FAF3E0] font-sans">
      ...
      {/* 🧩 Page Content */}      <section className="flex-grow px-6 md:px-12 lg:px-24 xl:px-32 py-12 min-h-[70vh] flex flex-col justify-center">
        <h1 className="text-5xl font-bold tracking-tighter mb-2">blog 📰</h1>
        <p className="font-serif text-lg text-[#FAF3E0]/90 mb-6">
