  ...
  return (
    <main className="flex flex-col bg-[#1A1A1A] text-[#FAF3E0] font-sans relative">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/6 right-1/5 w-80 h-80 bg-[#FAF3E0]/3 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/5 left-1/6 w-64 h-64 bg-[#FAF3E0]/2 rounded-full blur-2xl animate-bounce" style={{animationDuration: '7s'}}></div>
        <div className="absolute top-3/5 right-1/2 w-48 h-48 bg-[#FAF3E0]/4 rounded-full blur-xl animate-pulse" style={{animationDelay: '2.5s'}}></div>
      </div>
        ...
        <div className={`flex flex-col items-start text-left transition-all duration-1000 max-w-2xl ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="bg-[#FAF3E0]/5 backdrop-blur-sm rounded-lg p-6 border border-[#FAF3E0]/10">
            <p className="text-[#FAF3E0]/80 font-serif text-left">
              🌸 Embracing the art of elegant simplicity. This project focuses on refined aesthetics and mindful design.
            </p>
          </div>
        </div>
