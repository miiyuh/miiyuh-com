...
export interface Project {
  ...
  title: string;
  /**
   * URL-friendly version of the title (e.g., "my-project")
   */
  slug: string;
  description: string;
  content: {
  ...
  category: 'academic' | 'personal' | 'professional' | 'open-source' | 'papers';
  /**
   * List the technologies, languages, or tools used in this project
   */
  technologies?:
    | {
        technology: string;
  ...
  endDate?: string | null;
  /**
   * Display this project prominently on the projects page
   */
  featured?: boolean | null;
  status: 'draft' | 'published';
  updatedAt: string;
...
export interface BlogPost {
  ...
  slug: string;
  /**
   * Short summary of the blog post for previews
   */
  excerpt: string;
  content: {
    root: {
  ...
  categories?:
    | {
        category: 'technology' | 'design' | 'photography' | 'personal' | 'tutorial' | 'review';
        id?: string | null;
      }[]
    | null;
  /**
   * Add tags to help categorize and search for this post
   */
  tags?:
    | {
        tag: string;
